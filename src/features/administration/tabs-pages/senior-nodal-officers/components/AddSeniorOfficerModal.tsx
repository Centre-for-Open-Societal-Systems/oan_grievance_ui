...
const reportsToOptions = [
  { value: 'Tigist Alemu', label: 'Tigist Alemu — Inputs Supply & Distribution Agency' },
  { value: 'Dawit Haile', label: 'Dawit Haile — Market Development & Trade Bureau' },
  { value: 'Selam Bekele', label: 'Selam Bekele — Agricultural Finance Institute (AFI)' },
  { value: 'Hana Girma', label: 'Hana Girma — Ministry of Agriculture (MoA)' },
  { value: 'Lemma Kassa', label: 'Lemma Kassa — Cooperative Promotion Agency' },
  { value: 'Biruk Tesfaye', label: 'Biruk Tesfaye — Agricultural Finance Institute (AFI)' }
];

interface AddSeniorOfficerModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export function AddSeniorOfficerModal({ isOpen, onClose }: AddSeniorOfficerModalProps) {
      ...
      <div className="flex min-h-full items-center justify-center">
        <div className="bg-white rounded-xl shadow-xl w-full max-w-3xl flex flex-col font-sans">
          ...
          <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200">
            <h2 className="text-xl font-bold text-gray-900">Add Senior Nodal Officer</h2>
            <button
              onClick={onClose}
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
              ...
              {/* Reports To (L1 Officer)  */}
              <div>
                <label className="block text-sm font-semibold text-gray-800 mb-1.5">
                  Reports To (L1 Officer) <span className="text-red-500">*</span>
                </label>
                <CustomSelect
