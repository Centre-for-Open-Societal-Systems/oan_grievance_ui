import { Mail, Phone, Globe, Pencil, ArrowRight } from 'lucide-react';
...
export function SeniorOfficerCard({ officer, onEdit }: { officer: Officer, onEdit?: (officer: Officer) => void }) {
  return (
      ...
      <div className="space-y-2 mb-4">
        ...
        {officer.reportsTo && (
          <div className="flex items-center gap-2 text-[14px] text-gray-500">
            ...
            Reports to: <span className="font-semibold text-gray-900">{officer.reportsTo}</span>
          </div>
        )}
      </div>
