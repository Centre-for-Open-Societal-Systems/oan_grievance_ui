...
import { Officer } from './SeniorOfficerCard';
...
interface EditSeniorOfficerModalProps {
  isOpen: boolean;
  onClose: () => void;
  officer: Officer | null;
}

export function EditSeniorOfficerModal({ isOpen, onClose, officer }: EditSeniorOfficerModalProps) {
